...
- **3D‑Pose Estimation Workload:**
	...
	- **Input:** RGB video of a person in motion (for example, `face-demographics-walking.mp4` under `/videos/3d-pose`).
...
- **Proxy Support (optional):**
	...
	- For Java‑based components (MDPnP, DDS‑Bridge), configure Gradle proxies in `~/.gradle/gradle.properties` as described in the top‑level README.
