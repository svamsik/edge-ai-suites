...
/usr/local/bin/scenescape-init webserver --dbhost smart-intersection-pgserver --dbtype postgres --dbport "5432" --broker broker.scenescape.intel.com --brokerauth /run/secrets/browser.auth --brokerrootcert /run/secrets/certs/scenescape-ca.pem
{{- end -}}