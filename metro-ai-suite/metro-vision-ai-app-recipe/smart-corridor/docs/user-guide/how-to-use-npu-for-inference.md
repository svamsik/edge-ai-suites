...
In `edge-ai-suites/metro-ai-suite/metro-vision-ai-app-recipe/smart-corridor/src/dlstreamer-pipeline-server/config.json` the following NPU pipelines are available. Set `"auto_start": true` for each of them.
