...
class test_suite(unittest.TestCase):
    ...
    def TC_001_SP(self):
        env["TEST_CASE"] = "SP001"
        ret = subprocess.call("python3 -m unittest -v functional_tests/apps.py", shell=True, env=env, cwd='../')
        return ret
    ...
    def TC_001_SPHELM(self):
        ...
        ret = subprocess.call("python3 -m unittest -v functional_tests/apps_helm.py", shell=True, env=env, cwd='../')
        return ret
