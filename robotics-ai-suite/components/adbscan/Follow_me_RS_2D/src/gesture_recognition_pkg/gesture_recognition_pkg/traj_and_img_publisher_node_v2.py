    ...
    def publish(self):
        ...
        if (self.pos_[1] > -0.1) and self.rpy_[2] < 0:
            ...
            self.get_logger().info(
                'stage 1: x_pos:{}, y_pos:{}, z_orientation: {}'.format(
                    self.pos_[0], self.pos_[1], self.rpy_[2]
                )
            )
            ...
            self.get_logger().info(
                'stage 2: x_pos:{}, y_pos:{}, z_orientation: {}'.format(
                    self.pos_[0], self.pos_[1], self.rpy_[2]
                )
            )
        elif (
            ...
            twist_msg.angular.z = 0.0
            self.get_logger().info(
                'stage 3: x_pos:{}, y_pos:{}, z_orientation: {}'.format(
                    self.pos_[0], self.pos_[1], self.rpy_[2]
                )
            )
            ...
            twist_msg.angular.z = -0.25
            self.get_logger().info(
                'stage 4: x_pos:{}, y_pos:{}, z_orientation: {}'.format(
                    self.pos_[0], self.pos_[1], self.rpy_[2]
                )
            )
            ...
            twist_msg.angular.z = 0.0
            self.get_logger().info(
                'stage 5: x_pos:{}, y_pos:{}, z_orientation: {}'.format(
                    self.pos_[0], self.pos_[1], self.rpy_[2]
                )
            )
            ...
            twist_msg.angular.z = -0.25
            self.get_logger().info(
                'stage 6: x_pos:{}, y_pos:{}, z_orientation: {}'.format(
                    self.pos_[0], self.pos_[1], self.rpy_[2]
                )
            )
        elif (
            ...
            twist_msg.angular.z = 0.0
            self.get_logger().info(
                'stage 7: x_pos: {}, y_pos:{}, z_orientation: {}'.format(
                    self.pos_[0], self.pos_[1], self.rpy_[2]
                )
            )
            ...
            self.get_logger().info(
                'stage 8: x_pos:{}, y_pos:{}, z_orientation: {}'.format(
                    self.pos_[0], self.pos_[1], self.rpy_[2]
                )
            )
        elif (self.pos_[1] > -1.3) and self.pos_[1] < 1.2 and self.rpy_[2] > 0:
            twist_msg.linear.x = 0.1
            twist_msg.linear.y = 0.0
            twist_msg.linear.z = 0.0
            twist_msg.angular.x = 0.0
            ...
            twist_msg.angular.z = 0.0
            self.get_logger().info(
                'stage 9: x_pos:{}, y_pos:{}, z_orientation: {}'.format(
                    self.pos_[0], self.pos_[1], self.rpy_[2]
                )
            )
        else:
