...
public:
  ...
  {
    publisher_ =
      this->create_publisher<nav2_dynamic_msgs::msg::ObstacleArray>("Obstacle_Array", 10);
...
private:
  void publish_message()
  {
    ...
    RCLCPP_INFO(
      this->get_logger(), "Publishing size(): '%d'",
      (obstacleArr_msg.obstacles).size());  // (message.obstacles[0].size.z));
