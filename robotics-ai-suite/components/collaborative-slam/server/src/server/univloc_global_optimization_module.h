...
public:
  //! Constructor
  univloc_global_optimization_module(
...
private:
  void Local_BA_for_merging_map(
    std::vector<data::keyframe *> adjust_keyframes, std::vector<data::keyframe *> fixed_keyframes);
