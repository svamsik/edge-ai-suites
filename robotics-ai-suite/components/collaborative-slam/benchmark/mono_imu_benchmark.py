...
class MonocularInertialBenchmark:
    ...
    def result_isavailable(self):
        ...
        # else:
        #     print(
        #         'Produced trajectory duration did not cover at least 50% of reference trajectory!'  # noqa: E501
        #     )
        #     return -2
        return 0
    ...
    def run_single_test(self):
        ...
        launch_params = [
            'camera_setup:=Monocular_Inertial',
            'gui:=false',
            'rviz:=false',
            'publish_tf:=false',
            'log_level:=warning',
...
def args_parse(default_bagfile_dir):
    parser = argparse.ArgumentParser(
        description='Automatically run EuRoC dataset with monocular and imu input and print the accuracy data to standard output'  # noqa: E501
    )
    parser.add_argument(
        'dataset',
        type=str,
...
def generate_test_list(bagfile_list, bagfile_prefix_list, groundtruth_list, args_dict):
    ...
    for name in groundtruth_list:
        ...
        item = MonocularInertialBenchmark(
