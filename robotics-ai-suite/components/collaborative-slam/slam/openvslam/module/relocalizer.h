...
public:
  //! Constructor
  explicit relocalizer(
    data::bow_database * bow_db, camera::setup_type_t camera_type,
...
private:
  ...
  std::shared_ptr<data::keyframe> get_covisibility_keyfrm(
