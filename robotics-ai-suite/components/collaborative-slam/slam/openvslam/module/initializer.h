...
// initializer state
enum class initializer_state_t { NotReady, Initializing, Wrong, Succeeded };
...
public:
  ...
  KeyframeID get_initial_frame_id() const;

  void set_initial_frame_id(KeyframeID id);
...
private:
  ...
  KeyframeID init_frm_id_ = 0;

  const Mat44_t initial_pose_;
