...
public:
   ...
   * of the candidate
   */
  std::vector<data::landmark *> current_matched_landmarks_observed_in_candidate_covisibilities()
    const;
...
protected:
  ...
  //! matches between the keypoint indices of the current keyframe and the landmarks observed
  //! in the candidate
  std::vector<data::landmark *> curr_match_lms_observed_in_cand_;
  //! matches between the keypoint indices of the current keyframe and the landmarks observed
  //! in covisibilities of the
  //! candidate
