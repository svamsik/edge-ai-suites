...
public:
  // This landmark may replace another landmark in client after local mapping and
  // this message need to be sent to server
  LandmarkID replace_other_id_;
...
private:
  ...
  //! Normalized average vector (unit vector) of keyframe->lm, for keyframes such that observe
  //  the 3D point.
  Vec3_t mean_normal_;
