...
public:
   ...
   */
  keyframe(
    const frame & frm, map_database * map_db, bow_database * bow_db, ClientID client_id,
    MapID map_id);
  ...
  /**
   * Only used to remove within remapping region, also includes loop edges and origin keyframes
   */
  void prepare_for_erasing_remapping();
  ...
  std::vector<cv::Vec3b> colors{{128, 64, 128},  {232, 35, 244},  {70, 70, 70},   {156, 102, 102},
