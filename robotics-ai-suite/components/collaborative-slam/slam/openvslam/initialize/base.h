...
public:
  ...
  base(
    ...
    const unsigned int min_num_triangulated, const float parallax_deg_thr,
  ...
  virtual bool initialize(
    const data::frame & cur_frm, const std::vector<int> & ref_matches_with_cur) = 0;
