...
using Mat23_t = MatRC_t<2, 3>;

using Mat36_t = MatRC_t<3, 6>;

using MatX_t = Eigen::MatrixXd;

using Dym_Mat_t = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor>;
