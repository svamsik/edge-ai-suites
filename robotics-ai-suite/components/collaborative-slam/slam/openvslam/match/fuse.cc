...
unsigned int fuse::detect_duplication(
...
template <typename T>
unsigned int fuse::replace_duplication(
  data::keyframe * keyfrm, const T & landmarks_to_check, const float margin)
{
  unsigned int num_fused = 0;
...
template unsigned int fuse::replace_duplication(
  data::keyframe *, const std::vector<data::landmark *> &, const float);
template unsigned int fuse::replace_duplication(
  data::keyframe *, const std::unordered_set<data::landmark *> &, const float);
