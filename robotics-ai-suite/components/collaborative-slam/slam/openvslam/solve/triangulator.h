...
public:
  ...
  */
  static inline Vec3_t triangulate(
    const cv::Point2d & pt_1, const cv::Point2d & pt_2, const Mat34_t & P_1, const Mat34_t & P_2);
  ...
  */
  static inline Vec3_t triangulate(
    const Vec3_t & bearing_1, const Vec3_t & bearing_2, const Mat33_t & rot_21,
  ...
  */
  static inline Vec3_t triangulate(
    const Vec3_t & bearing_1, const Vec3_t & bearing_2, const Mat44_t & cam_pose_1,
    const Mat44_t & cam_pose_2);
};

Vec3_t triangulator::triangulate(
  const cv::Point2d & pt_1, const cv::Point2d & pt_2, const Mat34_t & P_1, const Mat34_t & P_2)
{
  Mat44_t A;
  ...
  const Mat44_t & cam_pose_2)
{
  ...
  // decomposition of A to the singular value (A = U S Vt)
