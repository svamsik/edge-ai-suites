...
essential_solver::essential_solver(
...
Mat33_t essential_solver::compute_E_21(
  const eigen_alloc_vector<Vec3_t> & bearings_1, const eigen_alloc_vector<Vec3_t> & bearings_2)
{
...
bool essential_solver::decompose(
...
Mat33_t essential_solver::create_E_21(
  const Mat33_t & rot_1w, const Vec3_t & trans_1w, const Mat33_t & rot_2w, const Vec3_t & trans_2w)
{
