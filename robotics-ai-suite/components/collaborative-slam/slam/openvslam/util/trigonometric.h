...
#ifndef OPENVSLAM_UTIL_TRIGONOMETRIC_H
#define OPENVSLAM_UTIL_TRIGONOMETRIC_H
...
inline float sin(float v) { return openvslam::util::cos(_PI_2 - v); }

}  // namespace util
}  // namespace openvslam

#endif  // OPENVSLAM_UTIL_TRIGONOMETRIC_H
