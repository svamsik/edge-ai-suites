...
{
  // cv::cvtColor will allocate new memory when size or type between input and output are different
  if (img.channels() == 3) {
...
{
  // convertTo will allocate new memory when size or type between input and output are different
