...
public:
  ...
  explicit global_bundle_adjuster(
    const KeyframeID first_keyfrm_id_in_db, data::map_database * map_db,
   ...
   */
  void optimize(
    const KeyframeID lead_keyfrm_id_in_global_BA = 0, bool * const force_stop_flag = nullptr) const;
  void optimize(
