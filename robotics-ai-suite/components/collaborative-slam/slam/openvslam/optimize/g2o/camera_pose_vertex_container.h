...
public:
   ...
   * @param num_reserve
   */
  explicit camera_pose_vertex_container(
    const KeyframeID offset, const unsigned int num_reserve = 200);
   ...
   * @return
   */
  inline camera_pose_vertex * get_vertex(const KeyframeID id) const
  {
   ...
   * @return
   */
  inline camera_pose_vertex * get_vertex(data::keyframe * keyfrm) const
  {
