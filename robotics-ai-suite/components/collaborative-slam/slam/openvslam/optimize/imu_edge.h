...
public:
  ...
  {
    return {
      camera_->fx_ * pos_c(0) / pos_c(2) + camera_->cx_,
      camera_->fy_ * pos_c(1) / pos_c(2) + camera_->cy_};
  }
...
class EdgeStereo
: public ::g2o::BaseBinaryEdge<3, Eigen::Vector3d, ::g2o::VertexPointXYZ, VertexPose>
{
public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
