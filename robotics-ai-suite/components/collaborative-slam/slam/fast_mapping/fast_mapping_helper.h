...
// We want to make the first 8 bits of "pose_id_" represent client ID and the remaining 56 bits
// represent the corresponding (key)frame's timestamp.
...
public:
  ...
  // check if a given line segment intersects with any edges
