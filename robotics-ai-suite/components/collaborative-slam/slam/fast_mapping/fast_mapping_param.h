...
struct camera_intrinsics
{
  ...
  camera_intrinsics() : width(0), height(0), cx(0), cy(0), fx(0), fy(0) {}

  camera_intrinsics(
    const int width_, const int height_, const float cx_, const float cy_, const float fx_,
    const float fy_)
  ...
  inline Eigen::Matrix3f invK() const { return K().inverse(); }
  ...
  inline Eigen::Matrix4f invK4() const { return K4().inverse(); }
