...
params = {
    ...
    'image_topic': '/drivers/realsense/infra1/image_rect_raw0',
    'right_image_topic': '/drivers/realsense/infra2/image_rect_raw0',
    'camera_info_topic': '/drivers/realsense/infra1/camera_info0',
    'right_camera_info_topic': '/drivers/realsense/infra2/camera_info0',
    'enable_rectifier': 'false',
    'camera_fps': '6.0',  # FPS of input realsense camera images, please change the value to align with the camera  # noqa: 501
}
...
def generate_launch_description():
    configFilePath = os.path.join(
        get_package_share_directory('univloc_tracker'), 'config', 'geekplus.yaml'
    )
