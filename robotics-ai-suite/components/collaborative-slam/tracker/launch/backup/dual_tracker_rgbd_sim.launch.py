...
def generate_launch_description():
    ld = launch.LaunchDescription(
        [
            launch.actions.DeclareLaunchArgument(name='camera1', default_value='front_camera'),
            launch.actions.DeclareLaunchArgument(name='camera2', default_value='rear_camera'),
            launch.actions.DeclareLaunchArgument(name='ID1', default_value='0'),
            launch.actions.DeclareLaunchArgument(name='ID2', default_value='1'),
            launch.actions.DeclareLaunchArgument(name='camera_setup1', default_value='RGBD'),
            launch.actions.DeclareLaunchArgument(name='camera_setup2', default_value='RGBD'),
            launch.actions.DeclareLaunchArgument(name='image1', default_value='d455_color'),
            launch.actions.DeclareLaunchArgument(name='image2', default_value='d455_color'),
            launch.actions.DeclareLaunchArgument(name='depthmap_factor', default_value='1.0'),
            ...
            launch.actions.DeclareLaunchArgument(name='camera_fps1', default_value='30.0'),
            launch.actions.DeclareLaunchArgument(name='camera_fps2', default_value='30.0'),
