...
protected:
  ...
  void update_frm_and_keyfrm_using_relocalization(
  ...
  typedef tracker_state_t (univloc_tracking_module::*track_trans_state_mode)(
    bool is_succeeded, std::any & pre_info);
  ...
  //! for Kalman filter, it is used to avoid publishing pose when tracker resets and haven't merged
  //! with global map
