...
private:
  ...
  FeatureQueue
    feature_queue_;  // images and features from feature_extraction_module to tracking_module
  RequestQueue result_queue_;  // images and poses from tracking_module to user
  RequestQueue
    reconstruction_queue_;  // images and poses from tracking module to fast_mapping module
