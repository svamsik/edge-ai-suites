...
public:
  ...
  : rclcpp::Duration(std::chrono::nanoseconds{static_cast<int64_t>(seconds * 1e9)})
  {
  }
...
public:
  ...
  void publish_transform(
    tf2::Transform transform, TimeT stamp, std::string parent, std::string child)
  {
  ...
  rosx::TfLookupResult get_transform(
    tf2::Stamped<tf2::Transform> & transform, std::string target, std::string source,
  ...
  rosx::TfLookupResult get_transform(
    tf2::Stamped<tf2::Transform> & transform, std::string target, rosx::Time t_stamp,
