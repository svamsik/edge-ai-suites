...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('robot_config')
    launch_dir = os.path.join(bringup_dir, 'launch', 'nav2_bringup', ros_distro)
    ...
    declare_map_server_cmd = DeclareLaunchArgument(
        'map_server', default_value='False', description='Whether run a map server per nav2 stack'
    )
